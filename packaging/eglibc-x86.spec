...
%package arm
Summary: C library for accelerator cross build. 
Group: Development/Libraries 
Requires: %{newname}-arm = %{version}-%{release}
Provides: glibc-x86-arm

%description arm
this is a hack package to make eglibc replace glibc.
...
shellquote "  targettype arm provides \"glibc-x86-arm\"" >> /tmp/baselibs_new.conf
